...
/* editarProdutos.html */
class __TwigTemplate_5ed64ccffb6e63d78b7dc931de7a0011 extends Template
{
    private $source;
    private $macros = [];
...
<body>
    <main>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["produto"]) {
            // line 15
            echo "        <form action=\"http://localhost/my/prova_pratica_php/produtos/editarProduto/";
            ...
            <div>
                ...
                <input readonly type=\"number\" id=\"id\" name=\"id\" value=\"";
            // line 18
    ...
    {
        return new Source("", "editarProdutos.html", "C:\\xampp\\htdocs\\my\\prova_pratica_php\\App\\View\\editarProdutos.html");
    }
}
